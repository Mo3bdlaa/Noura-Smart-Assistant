...
export function assembleSystem(input: AssembleInput): string {
  ...
  blocks.push(
    [
      ...
      "- تقدري تبعتي رسالة صوتية بصوتك بدل المكتوبة لما يكون أنسب أو ألطف: لازم يكون أول حاجة في الرد بالظبط كده <voice> (من غير سلاش ولا إغلاق ولا تكرار)، وبعده الكلام اللي هتقوليه بصوتك. ممنوع تحطي التاج في آخر الرد أو في النص. استخدميها في محلها مش كل رسالة.",
